...
public class VietAnhDAO implements DAOInterface<Word> {

    public static VietAnhDAO getInstance() {
        return new VietAnhDAO();
    }
    ...
    public int insert(Word word) {
        ...
        try {
            ...
            String SQL = "REPLACE INTO vietanhdict (word, textDescription, htmlDescription) "
                    + " VALUES (?, ?, ?)" ;
    ...
    public int delete(Word word) {
        ...
        try {
            ...
            String SQL = "DELETE FROM vietanhdict " +
                    " WHERE word = ? ";
            PreparedStatement pStatement = connection.prepareStatement(SQL);
            pStatement.setString(1, word.getKey());
    ...
    public ArrayList<String> suggestByKeyWord(String kword) {
        ...
        try {
            ...
            String SQL = "SELECT word FROM vietanhdict " +
                    " WHERE word LIKE ? ";
            PreparedStatement pStatement = connection.prepareStatement(SQL);
    ...
    public Word selectByKeyWord(String kword) {
        ...
        try {
            ...
            String SQL = "SELECT * FROM vietanhdict " +
                    " WHERE word = ? ";
            PreparedStatement pStatement = connection.prepareStatement(SQL);
            pStatement.setString(1, kword);
